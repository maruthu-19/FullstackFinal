...
import com.spring.service.Mservice;
...
public class Mcontroller {
	...
	public List<AppModel>sorting(@PathVariable String field)
	{
	...
	public List<AppModel>pagination(@PathVariable int offset,@PathVariable int pagesize)
	{
